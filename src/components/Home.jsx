      ...
      <div className="hero-section">
        <div className="short-intro item">
          ...
          <p>
            ...
            passionate about my work. I am a frontend developer based in
            Bangalore and I am very mush passionate about my work. I am a
            frontend developer based in Bangalore and I am very mush passionate
            about my work. I am a frontend developer based in Bangalore and I am
            very mush passionate about my work.
          </p>
        </div>
